            ...
            <div class="modal-content">
				...
				<div class="container-fluid">
                    <form role="form" method="POST" action="addcustomer.php" enctype="multipart/form-data">
						...
						<div class="form-group input-group">
                            <span style="width:120px;" class="input-group-addon">Nombre:</span>
                            <input type="text" style="width:320px; text-transform:capitalize;" class="form-control" name="name" required>
                        </div>
						<div class="form-group input-group">
                            <span style="width:120px;" class="input-group-addon">Dirección:</span>
                            <input type="text" style="width:310px; text-transform:capitalize;" class="form-control" name="address">
                        </div>
						<div class="form-group input-group">
                            <span style="width:120px;" class="input-group-addon">Contacto:</span>
                            <input type="text" style="width:310px;" class="form-control" name="contact">
                        </div>
						<div class="form-group input-group">
                            <span style="width:120px;" class="input-group-addon">Usuario:</span>
                            <input type="text" style="width:320px;" class="form-control" name="username" required>
                        </div>
						<div class="form-group input-group">
                            <span style="width:120px;" class="input-group-addon">Contraseña:</span>
                            <input type="password" style="width:300px;" class="form-control" name="password" required>
                        </div>
						</div>
				</div>
				</div>
